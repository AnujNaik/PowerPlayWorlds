...
@Config
@Autonomous
public class LeftAutoSharedHighSafe extends LinearOpMode {
    Pooja pooja;
    ...
    public static double XPOS = 58, YPOS = 3.0, ANGLE = 110; // 112, 58.7, 5.5
...
//        sleep(10000);
        ...
        boolean noPark = pooja.retractCollectConeSafe(telemetry, 5, "left");
        if (!noPark) {
            // park
            if (parkingZone == 1) {
...
//        sleep(1000);
        ...
        if (noPark) {
            ...
            noPark = pooja.retractCollectConeSafe(telemetry, 4, "left");
            if (!noPark) {
                // park
                if (parkingZone == 1) {
                    pooja.followTrajectorySequence(parkInZone1);
...
//        sleep(1000);
        ...
        if (noPark) {
            ...
            noPark = pooja.retractCollectConeSafe(telemetry, 3, "left");
            if (!noPark) {
                // park
                if (parkingZone == 1) {
                    pooja.followTrajectorySequence(parkInZone1);
...
//        sleep(1000);
        ...
        if (noPark) {
            ...
            noPark = pooja.retractCollectConeSafe(telemetry, 2, "left");
            if (!noPark) {
                // park
                if (parkingZone == 1) {
                    pooja.followTrajectorySequence(parkInZone1);
...
//        sleep(1000);
        ...
        if (noPark) {
            ...
            noPark = pooja.retractCollectConeSafe(telemetry, 1, "left");
            if (!noPark) {
                // park
                if (parkingZone == 1) {
                    pooja.followTrajectorySequence(parkInZone1);
