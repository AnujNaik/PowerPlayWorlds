...
@Config
@Autonomous
public class RightAutoSharedHigh extends LinearOpMode {
    Pooja pooja;
...
//        brake.start();
        ...
        pooja.extendCollectCone(telemetry, 5, "right");
        pooja.retractCollectCone(telemetry, 5, "right");
        pooja.raiseDepositSlides(telemetry, "high");
        pooja.lowerDepositSlides(telemetry);
//        sleep(1000);

        pooja.extendCollectCone(telemetry, 4, "right");
        pooja.retractCollectCone(telemetry, 4, "right");
        pooja.raiseDepositSlides(telemetry, "high");
        pooja.lowerDepositSlides(telemetry);
//        sleep(1000);

        pooja.extendCollectCone(telemetry, 3, "right");
        pooja.retractCollectCone(telemetry, 3, "right");
        pooja.raiseDepositSlides(telemetry, "high");
        pooja.lowerDepositSlides(telemetry);
//        sleep(1000);

        pooja.extendCollectCone(telemetry, 2, "right");
        pooja.retractCollectCone(telemetry, 2, "right");
        pooja.raiseDepositSlides(telemetry, "high");
        pooja.lowerDepositSlides(telemetry);
//        sleep(1000);

        pooja.extendCollectCone(telemetry, 1, "right");
        pooja.retractCollectCone(telemetry, 1, "right");
        pooja.raiseDepositSlides(telemetry, "high");
        pooja.lowerDepositSlides(telemetry);
        pooja.FBToTransfer();
    ...
    private class CollectCone extends Thread {
        ...
        public void run() {
            try {
                pooja.extendCollectCone(telemetry, this.stackLevel, "right");
